...
public class ClimatisationActivity extends AppCompatActivity {
    ...
    private void spinners() {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<>(ClimatisationActivity.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.filtrage));
    ...
    private void getVilles() {
        ...
        ArrayAdapter<String> villeAdapter= new ArrayAdapter<>(ClimatisationActivity.this, android.R.layout.simple_list_item_1,ville);
        ...
        call.enqueue(new Callback<List<Ville>>() {
            ...
            public void onFailure(Call<List<Ville>> call, Throwable t) {
                Toast.makeText(ClimatisationActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getData() {
        apiInterface = RetrofitClient.getRetrofitInstance().create(ApiInterface.class);
        Call<List<Employee>> call = apiInterface.getClimatisation();
        call.enqueue(new Callback<List<Employee>>() {
            @Override
            public void onResponse(Call<List<Employee>> call, Response<List<Employee>> response) {
                if(!response.isSuccessful()) {
                    Toast.makeText(ClimatisationActivity.this, response.code(), Toast.LENGTH_SHORT).show();
                    return;
                }
                List<Employee> postList = response.body();
                employeeAdapter = new EmployeeAdapter(ClimatisationActivity.this, postList);
